...
#define SystemColorType UIColor
#import <UIKit/UIKit.h>

#else

#define SystemColorType NSColor
#import <Appkit/Appkit.h>

#endif

@interface SystemColorType (Colorkit)
 ...
 */
+ (instancetype)contrastLumaColor:(SystemColorType*)color threshold:(CGFloat)threshold;
